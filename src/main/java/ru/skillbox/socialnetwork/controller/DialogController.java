...
public interface DialogController {
    ...
    ResponseEntity<DialogResponse> sendMessage(@RequestBody DialogRequest request);
    ...
    ResponseEntity<DialogResponse> dialogCreate(@RequestParam("userId") Long userId);

    /**Delete dialog by Id.*/
    @DeleteMapping("/api/v1/dialogs/")
    ResponseEntity<DialogResponse> dialogDelete(@RequestParam("dialogId") Long dialogId);
